...
class SiswaController extends Controller
{
    ...
    public function profile($id)
    {
        ...
        foreach ($matapelajaran as $mp) {
            if ($siswa->mapel()->wherePivot('mapel_id', $mp->id)->first()) {
                $categories[] = $mp->name;
                $data[] = $siswa->mapel()->wherePivot('mapel_id', $mp->id)->first()->pivot->value;
            }
        }
        // dd($data);

        return view('siswa.profile', compact('siswa', 'matapelajaran', 'categories', 'data')); //pass data $siswa, $matapelajaran, $categoreis -> profile.blade.php
    }
    ...
    public function addnilai(Request $request, $idsiswa)
    {
        ...
        return redirect('siswa/' . $idsiswa . '/profile')->with('success', 'Data value berjaya dimasukkan');
    }

    public function deletevalue($idsiswa, $idmapel)
    {
        $siswa = \App\Siswa::find($idsiswa);
        $siswa->mapel()->detach($idmapel);
        return redirect()->back()->with('success', 'Data value berhasil didelete');
    }
}
